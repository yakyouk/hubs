  ...
  tock: (function() {
    return function tock() {
      ...
      if (
        ...
        if (this.videoRecorder) {
          // OB Hack: OB Chromium FBs are multisampled by default and they don't allow blitting for multisampled FB when regions differ.
          // https://chromium.googlesource.com/chromium/src/gpu/+/master/command_buffer/service/gles2_cmd_decoder.cc#8899
          // We avoid using blitting and flip the resnder target pixels for OB.
          if (!isOculusBrowser) {
